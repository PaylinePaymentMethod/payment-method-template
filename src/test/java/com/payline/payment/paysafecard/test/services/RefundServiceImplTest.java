...
public class RefundServiceImplTest {
    ...
    public void init() throws InvalidRequestException {
        TemplatePaymentRequest paymentRequest = null;
        doReturn(paymentRequest).when(service).createRequest(any(RefundRequest.class));
        doNothing().when(service).updateRequest(any(TemplatePaymentRequest.class));
    ...
    public void refundRequest() throws IOException, URISyntaxException {
        ...
        when(httpClient.refund(any(TemplatePaymentRequest.class), anyBoolean())).thenReturn(Utils.createPaySafeResponse(json1), Utils.createPaySafeResponse(json2));
    ...
    public void refundRequestErrorINVALID_DATA() throws IOException, URISyntaxException {
        String json = "{" +
                ...
                "    'number': 3184" +
                "}";
        when(httpClient.refund(any(TemplatePaymentRequest.class), anyBoolean())).thenReturn(Utils.createPaySafeResponse(json));
    ...
    public void refundWithException() throws IOException, URISyntaxException {
        when(httpClient.refund(any(TemplatePaymentRequest.class), anyBoolean())).thenThrow(IOException.class);
