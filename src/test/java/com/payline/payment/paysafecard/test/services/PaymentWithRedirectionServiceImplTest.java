...
public class PaymentWithRedirectionServiceImplTest {
    ...
    public void init() throws InvalidRequestException {
        TemplateCaptureRequest captureRequest = new TemplateCaptureRequest("dumbId", Utils.createContractConfiguration(null, null, null, Utils.AUTHORISATION_VAL));
    ...
    public void finalizeRedirectionPayment() throws IOException, URISyntaxException {
        ...
        when(httpClient.retrievePaymentData(any(TemplateCaptureRequest.class), anyBoolean())).thenReturn(Utils.createAuthorizedPaySafeResponse());
        when(httpClient.capture(any(TemplateCaptureRequest.class), anyBoolean())).thenReturn(Utils.createSuccessPaySafeResponse());
    ...
    public void finalizeWithRetrievePaymentDataError() throws IOException, URISyntaxException {
        RedirectionPaymentRequest redirectionPaymentRequest = Mockito.mock(RedirectionPaymentRequest.class, Mockito.RETURNS_DEEP_STUBS);
        when(httpClient.retrievePaymentData(any(TemplateCaptureRequest.class), anyBoolean())).thenReturn(Utils.createBadPaySafeResponse());
    ...
    public void finalizeWithRetrievePaymentWrongStatus() throws IOException, URISyntaxException {
        String json = "{" +
                ...
                "}";
        RedirectionPaymentRequest redirectionPaymentRequest = Mockito.mock(RedirectionPaymentRequest.class, Mockito.RETURNS_DEEP_STUBS);
        when(httpClient.retrievePaymentData(any(TemplateCaptureRequest.class), anyBoolean())).thenReturn(Utils.createPaySafeResponse(json));
    ...
    public void finalizeWithCaptureError() throws IOException, URISyntaxException {
        RedirectionPaymentRequest redirectionPaymentRequest = Mockito.mock(RedirectionPaymentRequest.class, Mockito.RETURNS_DEEP_STUBS);
        when(httpClient.retrievePaymentData(any(TemplateCaptureRequest.class), anyBoolean())).thenReturn(Utils.createAuthorizedPaySafeResponse());
        when(httpClient.capture(any(TemplateCaptureRequest.class), anyBoolean())).thenReturn(Utils.createBadPaySafeResponse());
    ...
    public void finalizeWithCaptureWrongStatus() throws IOException, URISyntaxException {
        ...
        RedirectionPaymentRequest redirectionPaymentRequest = Mockito.mock(RedirectionPaymentRequest.class, Mockito.RETURNS_DEEP_STUBS);
        when(httpClient.retrievePaymentData(any(TemplateCaptureRequest.class), anyBoolean())).thenReturn(Utils.createAuthorizedPaySafeResponse());
        when(httpClient.capture(any(TemplateCaptureRequest.class), anyBoolean())).thenReturn(Utils.createPaySafeResponse(json));
    ...
    public void finalizeWithHttpException() throws IOException, URISyntaxException {
        RedirectionPaymentRequest redirectionPaymentRequest = Mockito.mock(RedirectionPaymentRequest.class, Mockito.RETURNS_DEEP_STUBS);
        when(httpClient.retrievePaymentData(any(TemplateCaptureRequest.class), anyBoolean())).thenThrow(IOException.class);
