package com.payline.payment.template.test;
...
public class Utils {
    ...
    public static final String CUSTOMER_MAIL = "psc.test+mypins_monextrefund_TBqVTNc@template.com";

    private static final Gson parser = new Gson();

    public static TemplatePaymentResponse createInitiatedPaySafeResponse() {
        String json = "{" +
                "    'object': 'PAYMENT'," +
    ...
    public static TemplatePaymentResponse createAuthorizedPaySafeResponse() {
        String json = "{" +
                "    'object': 'PAYMENT'," +
                "    'id': 'pay_9743636706_C4xKjolAPk439xoFnbvhZ9ckUq2aBCT4_EUR'," +
                "    'created': 1534498236365," +
    ...
    public static TemplatePaymentResponse createSuccessPaySafeResponse() {
        String json = "{" +
                "    'object': 'PAYMENT'," +
                "    'id': 'pay_9743636706_C4xKjolAPk439xoFnbvhZ9ckUq2aBCT4_EUR'," +
                "    'created': 1534498236365," +
    ...
    public static TemplatePaymentResponse createBadPaySafeResponse() {
        String json = "{" +
    ...
    public static TemplatePaymentResponse createPaySafeResponse(String json) {
        return parser.fromJson(json, TemplatePaymentResponse.class);
    }
    ...
    public static ContractParametersCheckRequest createContractParametersCheckRequest(String kycLevel, String minAge, String countryRestriction, String authorisation) {
        ...
        accountInfo.put(TemplateCardConstants.KYCLEVEL_KEY, kycLevel);
        accountInfo.put(TemplateCardConstants.MINAGE_KEY, minAge);
        accountInfo.put(TemplateCardConstants.COUNTRYRESTRICTION_KEY, countryRestriction);
        accountInfo.put(TemplateCardConstants.AUTHORISATIONKEY_KEY, authorisation);
...
//                .withPartnerConfiguration(partnerConfiguration)
    ...
    public static ContractConfiguration createContractConfiguration(String kycLevel, String minAge, String countryRestriction, String authorisation) {
        ...
        contractConfiguration.getContractProperties().put(TemplateCardConstants.KYCLEVEL_KEY, new ContractProperty(kycLevel));
        contractConfiguration.getContractProperties().put(TemplateCardConstants.MINAGE_KEY, new ContractProperty(minAge));
        contractConfiguration.getContractProperties().put(TemplateCardConstants.COUNTRYRESTRICTION_KEY, new ContractProperty(countryRestriction));
        contractConfiguration.getContractProperties().put(TemplateCardConstants.AUTHORISATIONKEY_KEY, new ContractProperty(authorisation));
    ...
    public static ContractConfiguration createDefaultContractConfiguration() {
        final ContractConfiguration contractConfiguration = new ContractConfiguration("", new HashMap<>());
        contractConfiguration.getContractProperties().put(TemplateCardConstants.AUTHORISATIONKEY_KEY, new ContractProperty(AUTHORISATION_VAL));
        contractConfiguration.getContractProperties().put(TemplateCardConstants.MINAGE_KEY, new ContractProperty(""));
        contractConfiguration.getContractProperties().put(TemplateCardConstants.KYCLEVEL_KEY, new ContractProperty(""));
        contractConfiguration.getContractProperties().put(TemplateCardConstants.COUNTRYRESTRICTION_KEY, new ContractProperty(""));
